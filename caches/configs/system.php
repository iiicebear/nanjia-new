...
'cookie_pre' => 'mKETU_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://localhost/nanjia/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://localhost/nanjia/statics/js/', //CDN JS
'css_path' => 'http://localhost/nanjia/statics/css/', //CDN CSS
'img_path' => 'http://localhost/nanjia/statics/images/', //CDN img
'app_path' => 'http://localhost/nanjia/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => '6GqAX55QxCgtf4fd2qie', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://localhost/nanjia/phpsso_server',	//接口地址
'phpsso_auth_key' => '6CFgVu1xZHDNpeAo1PlE80Z8G9lZCga9', //加密密钥
